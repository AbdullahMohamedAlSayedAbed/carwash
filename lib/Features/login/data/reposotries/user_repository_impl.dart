...
class UserRepositoryImpl implements UserRepository {
  ...
  Future<Either<Failure, void>> addCarType(String carType) async {
    try {
      ...
      return Left(
          ServerFailure( 'Failed to add car type: ${e.toString()}'));
    }
  }
  ...
  Future<Either<Failure, List<Map<String, dynamic>>>> getCars() async {
    try {
      ...
      return Left(
          ServerFailure( 'Failed to get car type: ${e.toString()}'));
    }
  }
  ...
  Future<Either<Failure, UserEntity>> loginWithFacebook() async {
    try {
      ...
      return Left(ServerFailure('Failed to sign in with Facebook: $e'));
    }
  }
  ...
  Future<Either<Failure, UserEntity>> loginWithGmail() async {
    try {
      ...
      return Left(ServerFailure('Failed to sign in with Google: $e'));
    }
  }
  ...
  Future<Either<Failure, bool>> checkIfCarTypeExists(String uid) async {
    try {
      ...
      return Left(ServerFailure('Failed to check car type: $e'));
    }
  }
}
